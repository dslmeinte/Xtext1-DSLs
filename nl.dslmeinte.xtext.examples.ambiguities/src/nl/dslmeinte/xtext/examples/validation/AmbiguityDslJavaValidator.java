...
import nl.dslmeinte.xtext.examples.ambiguityDsl.LFAssignment;
...
public class AmbiguityDslJavaValidator extends AbstractAmbiguityDslJavaValidator {
	...
	@Check
	public void check_variable_declaration(LFVariableDeclaration variableDeclaration) {
	...
	@Check
	public void check_assignment(LFAssignment assignment) {
