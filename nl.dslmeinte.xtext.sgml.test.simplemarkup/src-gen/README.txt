...
the folder doesn't actually exist. This means the GenerateSimpleMarkup.mwe2 workflow
cannot be run right after cloning, without first creating src-gen/ (as a regular folder,
not as a source folder).
