 ...
 * <ul>
 *   <li>{@link nl.dslmeinte.xtext.examples.dataModelDsl.DataType#getName <em>Name</em>}</li>
...
public interface DataType extends CompoundType, SimpleType
{
   ...
   * @see #setName(String)
   * @see nl.dslmeinte.xtext.examples.dataModelDsl.DataModelDslPackage#getDataType_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link nl.dslmeinte.xtext.examples.dataModelDsl.DataType#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
